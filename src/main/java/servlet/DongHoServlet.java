...
//	                dsTatCaDongHo(request, response);
	...
	private void thuongHieu(HttpServletRequest request, HttpServletResponse response) {
		// TODO Auto-generated method stub
		ThuongHieuDao dao = new ThuongHieuDao(dataSource);
		List<ThuongHieu> listThuongHieu = dao.getAllThuongHieu();
