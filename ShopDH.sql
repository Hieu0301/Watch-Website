...
(N'Đồng hồ nữ Seiko SUR474P1', 6850000, 11, N'Mẫu Seiko SUR474P1 thiết kế đơn giản chức năng 3 kim trên nền mặt số kích thước 29mm phù hợp cho các phái đẹp có phần cổ tay nhỏ.', 2,'https://cdn3.dhht.vn/wp-content/uploads/2023/09/SUR474P1.jpg'),
(N'Đồng hồ nữ Seiko SUP454P1', 10850000, 5, N'Mẫu Seiko SUP454P1 máy pin phiên bản Solar (Năng Lượng Ánh Sáng), nổi bật với phần vỏ máy thiết kế mỏng trẻ trung chỉ dày 6mm.', 2,'https://cdn3.dhht.vn/wp-content/uploads/2023/09/SUP454P1.jpg'),
(N'Đồng hồ nữ Seiko Lukia SRWZ10P1', 10500000, 5, N'Mẫu Seiko SRWZ10P1 thiết kế 3 núm vặn điều chỉnh các tính năng Chronograph (đo thời gian) tạo nên kiểu dáng 6 kim thời trang độc đáo.', 2,'https://cdn3.dhht.vn/wp-content/uploads/2023/09/SRWZ10P1.jpg'),
(N'Đồng hồ nữ Seiko Conceptual SUP428P1', 10290000, 5, N'Mẫu Seiko SUP428P1 phiên bản mặt số vuông được phối tone màu xà cừ cùng với thiết kế sang trọng đính các viên pha lê.', 2,'https://cdn3.dhht.vn/wp-content/uploads/2023/09/SUP428P1.jpg')
...
Create Table TatCaDongHo (
	maDHAll  INT IDENTITY(1, 1) not Null,
	tenDH Nvarchar(50) not Null,
	giaBan float(20),
	soLuong int,
	moTa Nvarchar(255),
	thuongHieuId int REFERENCES ThuongHieu(thuongHieuId) NOT NULL,
	maDH int REFERENCES DongHo(maDH) NOT NULL,
	hinhAnh varchar(255)
	Constraint [PK_TatCaDongHo] primary key (maDHAll)
)
...
CREATE TABLE GioHang (
    id INT IDENTITY(1, 1),
    maDongHo int REFERENCES DongHo(maDH) NOT NULL,
	tenDH Nvarchar(50) not Null,
	giaBan float(20),
    soLuong INT ,
...
Insert into GioHang
Values 
( 1, N'Đồng hồ Gucci nam GG0397S-006', 1002222, 1 )
